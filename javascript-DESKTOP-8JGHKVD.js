...
function exibirDiv() {
    ...
    // Exibir a Div que irá exibir o resultado
    document.getElementById("tela_3").style.display = 'block';

    // Desaparecer a div que adiciona os valores
    document.getElementById("tela_inicial").style.display = 'none';

    document.getElementById("tela_inicial_operacao").style.display = 'none';

    // Exibi a tela 
    document.getElementById("tela_4").style.display = 'block';
}
